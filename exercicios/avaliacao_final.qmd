...
ggplot(df_painel) +
  ...
  labs(title = "Painel de Amostragem: 15 Paisagens de Santana do Araguaia-PA",
       subtitle = "Recortes circulares de 3000m de raio (Interior de Floresta)",
       fill = "Uso do Solo") +
...
### Linha do tempo
 ...
 - 1973: Volkswagen adquire 140 mil hectares de terras públicas
    - Recebeu incentivos da  Superintendência de Desenvolvimento da Amazônia (SUDAM) no governo militar.
