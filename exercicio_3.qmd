---
title: "Exercício 3 - Pacotes R para Ecologia de Paisagen"
---
...
O que é raiz do projeto? O que significa `<!-- #| eval: true -->` e `#| eval: true`? O comando de uptade dos programas deu erro na redenrização
